...
def freq2erb(freq_axis):
    """ Conversion of a frequency f from ERB to Hertz 
...
def spectrum2dBA(spectrum, fs):
    ...
    A_standard = np.array ([-70.4, -63.4, -56.7, -50.5, -44.7, -39.4, -34.6, -30.2, -26.2, 
                            -22.5, -19.1, -16.1, -13.4, -10.9, -8.6, -6.6, -4.8, -3.2, 
                            -1.9, -0.8, 0, 0.6, 1, 1.2, 1.3, 1.2, 1, 0.5, -0.1, -1.1, -2.5,
                            -4.3, -6.6, -9.3  ])
    
    freq_standard = np.array([10, 12.5, 16, 20, 25, 31.5, 40, 50, 63, 80, 100, 125, 160,
